...
$a->setNamespace('sf_orm_default_2badb78179d61eae5fbf770d2a80bce853b14cde358f242f043e1d91962f6e41');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_2badb78179d61eae5fbf770d2a80bce853b14cde358f242f043e1d91962f6e41');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_2badb78179d61eae5fbf770d2a80bce853b14cde358f242f043e1d91962f6e41');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ListingRepository' => function () {
    return ($this->privates['App\Repository\ListingRepository'] ?? $this->load(__DIR__.'/getListingRepositoryService.php'));
}, 'App\\Repository\\MasterListingRepository' => function () {
    return ($this->privates['App\Repository\MasterListingRepository'] ?? $this->load(__DIR__.'/getMasterListingRepositoryService.php'));
